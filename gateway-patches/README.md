...
`SomewearGatewayProvider.smali` is the injected provider used by gateway v18. It:
...
- preserves the SC3 message ID across both attempts and suppresses a late
  cross-channel duplicate at the receiver.
