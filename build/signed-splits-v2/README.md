...
- `com.somewearlabs.swtak.plugin.apk` — base package containing `SomewearGatewayProvider`, the application-level Realm bootstrap, retained Somewear runtime, and API-v2 workspace invite enrollment bridge.
