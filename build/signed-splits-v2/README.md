...
- `com.somewearlabs.swtak.plugin.apk` — base package containing `SomewearGatewayProvider`, the application-level Realm bootstrap, retained Somewear runtime, API-v2 workspace invite enrollment and Node hardware-settings bridges, signature-protected QR scanner, and bound receive-lifetime service.
