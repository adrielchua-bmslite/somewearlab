...
- `com.somewearlabs.swtak.plugin.apk` — gateway v14 base package containing `SomewearGatewayProvider`, the application-level Realm bootstrap, retained Somewear runtime, controlled Radio-to-Satellite fallback, independently deliverable Radio/Satellite fragmentation and reassembly, API-v2 workspace invite enrollment, Node telemetry/settings, mesh status, message cancellation, power, cloud-backed file/image bridges, signature-protected QR scanner, and bound receive-lifetime service.
